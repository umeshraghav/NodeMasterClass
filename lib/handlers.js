...
handlers.index = function(data,callback){
    ...
    if(data.method == 'get'){
      ...
      var templateData = {
        'head.title' : 'Uptime Made Simple',
        'head.description' : 'We offer free uptime Monitor',
         'body.class' : 'index'
      };
...
handlers.accountCreate = function(data,callback){
      ...
      if(data.method == 'get'){
        ...
        var templateData = {
          ...
          'head.description' : 'Singup is Easy',
...
handlers.sessionCreate = function(data,callback){
    ...
    if(data.method == 'get'){
      ...
      var templateData = {
        ...
        'head.description' : 'Please Enter Phone No. and Password',
         'body.class' : 'accountCreate'
      };
      // Read in a template as a string
...
handlers.sessionDeleted = function(data,callback){
    ...
    if(data.method == 'get'){
      ...
      var templateData = {
        ...
        'head.description' : 'You Are Logged out of your account',
         'body.class' : 'accountCreate'
      };
      // Read in a template as a string
